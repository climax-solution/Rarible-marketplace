                ...
                <div className="col-sm-12 col-lg-6">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="d-flex mt-3">
                            ...
                            <div className="putOnMarketplace ml-2 border-radius border"><img src={sonsuz} width="40" alt="" /> <b>Open for bids</b></div>
                        </div>
                        ...
                        <h5 className="mt-5"><b>Choose collection</b></h5>
                        ...
                        <div className="d-flex mt-3">
                            <div className="putOnMarketplace border-radius border" onClick={() => {setSingleCollectionPopup(true); document.body.style.overflow = "hidden";}}>
                                <img src={plus} width="40" alt="" /><b> Create</b>
                        ...
                        <div className="mt-5">
                        <Link to="/CollectibleMultiInfo"><button className="btn-ping  w-100">Create Item</button></Link>
                        </div>
